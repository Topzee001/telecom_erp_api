...
# SECRET_KEY = 'django-insecure-l9+t8!gl*ffyg728zhpp6-hdky0tkaz@r+1d3%61$mqteh+9&c'
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-l9+t8!gl*ffyg728zhpp6-hdky0tkaz@r+1d3%61$mqteh+9&c')
...
ROOT_URLCONF = 'telecom_erp_api.urls'
...
WSGI_APPLICATION = 'telecom_erp_api.wsgi.application'
